...
bool CClientTCPSocket::ProcessPacket(const bytes* buffer, uint32 size, uint8 opcode)
{
...
bool CClientTCPSocket::ProcessExtPacket(const bytes* buffer, uint32 size, uint8 opcode)
{
	#ifdef __PACKET_RECV_DUMP__
	//printf("Rec: OPCODE %x \n",opcode);
	DumpMem(buffer,size);
...
bool CClientTCPSocket::ProcessED2Kv2Packet(const bytes* buffer, uint32 size, uint8 opcode)
{
	#ifdef __PACKET_RECV_DUMP__
