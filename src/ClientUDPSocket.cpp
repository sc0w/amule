...
void CClientUDPSocket::OnPacketReceived(uint32 ip, uint16 port, bytes* buffer, size_t length)
{
...
void CClientUDPSocket::ProcessPacket(bytes* packet, int16 size, int8 opcode, uint32 host, uint16 port)
{
	switch (opcode) {
