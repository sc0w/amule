...
public:
	...
	PartFileBufferedData(CFileAutoClose& file, bytes * data, uint64 _start, uint64 _end, Requested_Block_Struct *_block)
...
uint32 CPartFile::WriteToBuffer(uint32 transize, bytes* data, uint64 start, uint64 end, Requested_Block_Struct *block, const CUpDownClient* client)
{
