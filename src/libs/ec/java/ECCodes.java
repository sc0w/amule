...
public final static bytes EC_OP_NOOP                          = 0x01;
public final static bytes EC_OP_AUTH_REQ                      = 0x02;
public final static bytes EC_OP_AUTH_FAIL                     = 0x03;
public final static bytes EC_OP_AUTH_OK                       = 0x04;
public final static bytes EC_OP_FAILED                        = 0x05;
public final static bytes EC_OP_STRINGS                       = 0x06;
public final static bytes EC_OP_MISC_DATA                     = 0x07;
public final static bytes EC_OP_SHUTDOWN                      = 0x08;
public final static bytes EC_OP_ADD_LINK                      = 0x09;
public final static bytes EC_OP_STAT_REQ                      = 0x0A;
public final static bytes EC_OP_GET_CONNSTATE                 = 0x0B;
public final static bytes EC_OP_STATS                         = 0x0C;
public final static bytes EC_OP_GET_DLOAD_QUEUE               = 0x0D;
public final static bytes EC_OP_GET_ULOAD_QUEUE               = 0x0E;
public final static bytes EC_OP_GET_SHARED_FILES              = 0x10;
public final static bytes EC_OP_SHARED_SET_PRIO               = 0x11;
public final static bytes EC_OP_PARTFILE_SWAP_A4AF_THIS       = 0x16;
public final static bytes EC_OP_PARTFILE_SWAP_A4AF_THIS_AUTO  = 0x17;
public final static bytes EC_OP_PARTFILE_SWAP_A4AF_OTHERS     = 0x18;
public final static bytes EC_OP_PARTFILE_PAUSE                = 0x19;
public final static bytes EC_OP_PARTFILE_RESUME               = 0x1A;
public final static bytes EC_OP_PARTFILE_STOP                 = 0x1B;
public final static bytes EC_OP_PARTFILE_PRIO_SET             = 0x1C;
public final static bytes EC_OP_PARTFILE_DELETE               = 0x1D;
public final static bytes EC_OP_PARTFILE_SET_CAT              = 0x1E;
public final static bytes EC_OP_DLOAD_QUEUE                   = 0x1F;
public final static bytes EC_OP_ULOAD_QUEUE                   = 0x20;
public final static bytes EC_OP_SHARED_FILES                  = 0x22;
public final static bytes EC_OP_SHAREDFILES_RELOAD            = 0x23;
public final static bytes EC_OP_RENAME_FILE                   = 0x25;
public final static bytes EC_OP_SEARCH_START                  = 0x26;
public final static bytes EC_OP_SEARCH_STOP                   = 0x27;
public final static bytes EC_OP_SEARCH_RESULTS                = 0x28;
public final static bytes EC_OP_SEARCH_PROGRESS               = 0x29;
public final static bytes EC_OP_DOWNLOAD_SEARCH_RESULT        = 0x2A;
public final static bytes EC_OP_IPFILTER_RELOAD               = 0x2B;
public final static bytes EC_OP_GET_SERVER_LIST               = 0x2C;
public final static bytes EC_OP_SERVER_LIST                   = 0x2D;
public final static bytes EC_OP_SERVER_DISCONNECT             = 0x2E;
public final static bytes EC_OP_SERVER_CONNECT                = 0x2F;
public final static bytes EC_OP_SERVER_REMOVE                 = 0x30;
public final static bytes EC_OP_SERVER_ADD                    = 0x31;
public final static bytes EC_OP_SERVER_UPDATE_FROM_URL        = 0x32;
public final static bytes EC_OP_ADDLOGLINE                    = 0x33;
public final static bytes EC_OP_ADDDEBUGLOGLINE               = 0x34;
public final static bytes EC_OP_GET_LOG                       = 0x35;
public final static bytes EC_OP_GET_DEBUGLOG                  = 0x36;
public final static bytes EC_OP_GET_SERVERINFO                = 0x37;
public final static bytes EC_OP_LOG                           = 0x38;
public final static bytes EC_OP_DEBUGLOG                      = 0x39;
public final static bytes EC_OP_SERVERINFO                    = 0x3A;
public final static bytes EC_OP_RESET_LOG                     = 0x3B;
public final static bytes EC_OP_RESET_DEBUGLOG                = 0x3C;
public final static bytes EC_OP_CLEAR_SERVERINFO              = 0x3D;
public final static bytes EC_OP_GET_LAST_LOG_ENTRY            = 0x3E;
public final static bytes EC_OP_GET_PREFERENCES               = 0x3F;
public final static bytes EC_OP_SET_PREFERENCES               = 0x40;
public final static bytes EC_OP_CREATE_CATEGORY               = 0x41;
public final static bytes EC_OP_UPDATE_CATEGORY               = 0x42;
public final static bytes EC_OP_DELETE_CATEGORY               = 0x43;
public final static bytes EC_OP_GET_STATSGRAPHS               = 0x44;
public final static bytes EC_OP_STATSGRAPHS                   = 0x45;
public final static bytes EC_OP_GET_STATSTREE                 = 0x46;
public final static bytes EC_OP_STATSTREE                     = 0x47;
public final static bytes EC_OP_KAD_START                     = 0x48;
public final static bytes EC_OP_KAD_STOP                      = 0x49;
public final static bytes EC_OP_CONNECT                       = 0x4A;
public final static bytes EC_OP_DISCONNECT                    = 0x4B;
public final static bytes EC_OP_KAD_UPDATE_FROM_URL           = 0x4D;
public final static bytes EC_OP_KAD_BOOTSTRAP_FROM_IP         = 0x4E;
public final static bytes EC_OP_AUTH_SALT                     = 0x4F;
public final static bytes EC_OP_AUTH_PASSWD                   = 0x50;
public final static bytes EC_OP_IPFILTER_UPDATE               = 0x51;
public final static bytes EC_OP_GET_UPDATE                    = 0x52;
public final static bytes EC_OP_CLEAR_COMPLETED               = 0x53;
public final static bytes EC_OP_CLIENT_SWAP_TO_ANOTHER_FILE   = 0x54;
public final static bytes EC_OP_SHARED_FILE_SET_COMMENT       = 0x55;
public final static bytes EC_OP_SERVER_SET_STATIC_PRIO        = 0x56;
public final static bytes EC_OP_FRIEND                        = 0x57;
...
public final static bytes EC_DETAIL_CMD           = 0x00;
public final static bytes EC_DETAIL_WEB           = 0x01;
public final static bytes EC_DETAIL_FULL          = 0x02;
public final static bytes EC_DETAIL_UPDATE        = 0x03;
public final static bytes EC_DETAIL_INC_UPDATE    = 0x04;

public final static bytes EC_SEARCH_LOCAL         = 0x00;
public final static bytes EC_SEARCH_GLOBAL        = 0x01;
public final static bytes EC_SEARCH_KAD           = 0x02;
public final static bytes EC_SEARCH_WEB           = 0x03;

public final static bytes EC_VALUE_INTEGER        = 0x00;
public final static bytes EC_VALUE_ISTRING        = 0x01;
public final static bytes EC_VALUE_BYTES          = 0x02;
public final static bytes EC_VALUE_ISHORT         = 0x03;
public final static bytes EC_VALUE_TIME           = 0x04;
public final static bytes EC_VALUE_SPEED          = 0x05;
public final static bytes EC_VALUE_STRING         = 0x06;
public final static bytes EC_VALUE_DOUBLE         = 0x07;
